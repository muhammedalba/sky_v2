...
const RequestStep = dynamic(() => import('@/components/auth/forgot-password/RequestStep'), {
  loading: () => <div className="h-64 flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-primary/50" /></div>
});
const VerifyStep = dynamic(() => import('@/components/auth/forgot-password/VerifyStep'), {
  loading: () => <div className="h-64 flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-primary/50" /></div>
});
const ResetStep = dynamic(() => import('@/components/auth/forgot-password/ResetStep'), {
  loading: () => <div className="h-64 flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-primary/50" /></div>
});
