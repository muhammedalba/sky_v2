...
function DesktopNavbar({ categories }: DesktopNavbarProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      //React will automatically skip the update (bailout) if the value has not changed.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          ...
          <div className="flex items-center gap-8 h-14 justify-between">
            ...
            <Link href={`/home`} className="flex  items-center  shrink-0 group">
              ...
              <span className="hidden sm:flex text-md font-extrabold tracking-tight title-gradient px-1">
                {siteName || APP_NAME}
              </span>
            </Link>
