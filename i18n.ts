...
async function loadLocaleMessages(locale: string) {
  try {
    ...
    let common, dashboard, products, categories, orders, users, profile, home, contact, store, brands, carousel, subCategories, promoBanners, suppliers, coupons, settings, quote, cart, maintenance, locations;
    
    if (locale === 'ar') {
      [
        common, dashboard, products, categories, orders, users, profile, home, contact, store, brands, carousel, subCategories, promoBanners, suppliers, coupons, settings, quote, cart, maintenance, locations
      ] = await Promise.all([
