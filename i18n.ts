...
const loaders: Record<string, (locale: string) => Promise<unknown>> = {
  ...
  orders: (locale) =>
    import(`./messages/orders/${locale}.json`).then((m) => m.default),
  users: (locale) =>
    import(`./messages/users/${locale}.json`).then((m) => m.default),
  profile: (locale) =>
    import(`./messages/profile/${locale}.json`).then((m) => m.default),
  home: (locale) =>
  ...
  brands: (locale) =>
    import(`./messages/brands/${locale}.json`).then((m) => m.default),
  carousel: (locale) =>
    import(`./messages/carousel/${locale}.json`).then((m) => m.default),
  subCategories: (locale) =>
    import(`./messages/subCategories/${locale}.json`).then((m) => m.default),
  promoBanners: (locale) =>
    import(`./messages/promoBanners/${locale}.json`).then((m) => m.default),
  suppliers: (locale) =>
    import(`./messages/suppliers/${locale}.json`).then((m) => m.default),
  coupons: (locale) =>
    import(`./messages/coupons/${locale}.json`).then((m) => m.default),
  settings: (locale) =>
  ...
  maintenance: (locale) =>
    import(`./messages/maintenance/${locale}.json`).then((m) => m.default),
  locations: (locale) =>
    import(`./messages/locations/${locale}.json`).then((m) => m.default),
  roles: (locale) =>
  ...
  reviews: (locale) =>
    import(`./messages/reviews/${locale}.json`).then((m) => m.default),
};
...
async function loadLocaleMessages(locale: string) {
  ...
  try {
    ...
    console.error(
      `[i18n] Error loading translation files for ${locale}:`,
      error,
    );
    return {};
  }
