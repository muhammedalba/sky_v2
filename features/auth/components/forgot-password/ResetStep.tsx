...
const ResetStep = ({ email, passwordResetCode }: ResetStepProps) => {
  ...
  return (
    ...
    >
      ...
      <Button
        type="submit"
        className="w-full mt-5 h-12 text-base font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:scale-[1.02] transition-all"
        size="lg"
