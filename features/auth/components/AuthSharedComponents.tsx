...
export function AuthMobileLogo({
  ...
  return (
    <div
      className={` text-center mb-1 flex flex-col items-center py-4 ${className}`}
    >
...
export function AuthFormContainer({
  ...
  return (
    <div
      className={`bg-card/50 backdrop-blur-sm rounded-3xl p-8 sm:p-10 border border-border/50 shadow-2xl ${shadowColor}`}
    >
      {children}
    </div>
  );
...
export function AuthBackgroundDecorations({
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        className={`absolute top-[5%] right-[5%] w-[35%] h-[35%] ${colors.top} rounded-full blur-[100px]`}
      />
      <div
        className={`absolute bottom-[5%] left-[5%] w-[30%] h-[30%] ${colors.bottom} rounded-full blur-[80px]`}
      />
    </div>
  );
}
...
export function AuthHeader({
  ...
  return (
    <div className={`text-center space-y-2 ${className}`}>
      <h1 className="text-2xl md:text-3xl font-black title-gradient">
        {title}
      </h1>
...
export function AuthFooter({
  ...
  return (
    <footer
      className={`text-center pt-4 border-t border-border/50 ${className}`}
    >
