...
export function useProductFilters() {
  ...
  const setFilter = useCallback(
    (key: keyof ProductFilters, value: string | number | null) => {
  ...
  const setFilters = useCallback(
    (newFilters: Partial<Record<keyof ProductFilters, string | number | null>>) => {
  ...
  const { apiParams, filterErrors } = useMemo(() => {
    ...
    const weightMinVal =
      filters.weight_min !== "" ? Number(filters.weight_min) : null;
    const weightMaxVal =
      filters.weight_max !== "" ? Number(filters.weight_max) : null;
    const weightRangeInvalid =
      weightMinVal !== null &&
      weightMaxVal !== null &&
      weightMinVal > weightMaxVal;

    const volumeMinVal =
      filters.volume_min !== "" ? Number(filters.volume_min) : null;
    const volumeMaxVal =
      filters.volume_max !== "" ? Number(filters.volume_max) : null;
    const volumeRangeInvalid =
      volumeMinVal !== null &&
      volumeMaxVal !== null &&
      volumeMinVal > volumeMaxVal;
    ...
    const soldMinVal =
      filters.sold_min !== "" ? Number(filters.sold_min) : null;
    const soldMaxVal =
      filters.sold_max !== "" ? Number(filters.sold_max) : null;
    const soldRangeInvalid =
      soldMinVal !== null && soldMaxVal !== null && soldMinVal > soldMaxVal;
