    ...
    <div className={cn("flex flex-col md:flex-row md:items-end justify-between gap-6", className)}>
      <div className="space-y-1">
        ...
        <div className="text-sm font-medium text-muted-foreground">
          {totalResults && <Badge variant="success" className="rounded-full text-green-700 bg-green-100 hover:bg-green-300 font-bold text-[10px] gap-1.5 flex items-center w-fit group/badge transition-all duration-300">
