...
export const SubCategoriesIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM15 5a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM15 15a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-3z" />
    </svg>
  );

export const BrandsIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581a1.125 1.125 0 001.59 0l7.181-7.181a1.125 1.125 0 000-1.59l-9.581-9.581A2.25 2.25 0 009.568 3z" />
      <circle cx="7.5" cy="7.5" r="1.5" fill="currentColor" />
    </svg>
  );

export const CouponsIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const PromoBannersIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const GoogleIcon = ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.86-2.59 3.29-4.53 12-4.53z" fill="#EA4335"/>
    </svg>
  );

export const FacebookIcon = ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.99 3.66 9.12 8.44 9.88v-6.99H7.9V12h2.54V9.41c0-2.51 1.49-3.89 3.77-3.89 1.09 0 2.23.19 2.23.19v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.77l-.44 2.89h-2.33v6.99C18.34 21.12 22 16.99 22 12z" fill="#1877F2"/>
    </svg>
  );
...
export const PanelLeftOpenIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <rect width="18" height="18" x="3" y="3" rx="3" strokeWidth={2} />
      <path strokeWidth={2} d="M9 3v18" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15l3-3-3-3" />
    </svg>
  );

export const PanelLeftCloseIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <rect width="18" height="18" x="3" y="3" rx="3" strokeWidth={2} />
      <path strokeWidth={2} d="M9 3v18" />
...
export const AiSparkIcon = ({ className }: IconProps) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const TagsIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SnapchatBrandIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M12.11.02c1.47 0 2.87.21 4.16.63 1.25.41 2.4 1 3.4 1.77.9.69 1.63 1.52 2.14 2.48.51.97.79 2.05.79 3.19 0 1.2-.34 2.36-.97 3.42-.59 1-1.44 1.83-2.44 2.52.27.05.54.1.8.14.93.16 1.8.27 2.4.34.62.07.99.11.99.11 0 0 .15.02.26.06.12.05.2.14.24.27.04.13.01.27-.06.39-.08.13-.21.23-.39.29-.46.16-1.19.4-2.19.74-1.01.35-2.26.79-3.7 1.31v.01c.26.54.66 1.15 1.19 1.81.54.67 1.16 1.35 1.86 2.01.69.66 1.42 1.27 2.18 1.81.75.54 1.48 1.01 2.16 1.39.69.38 1.28.67 1.76.84.47.18.78.25.89.23.1-.01.12.06.12.06 0 0 .04.11.01.23-.04.13-.13.24-.26.31-.14.08-.31.11-.49.1-.56-.05-1.37-.2-2.42-.45-1.06-.25-2.31-.58-3.72-.98-1.41-.39-2.9-.84-4.42-1.3l-.33-.1-1.07.31c-.5.14-1.03.26-1.57.36s-1.12.16-1.72.2c-.6.04-1.22.06-1.84.06s-1.24-.02-1.84-.06c-.6-.04-1.18-.1-1.72-.2-.54-.1-1.07-.22-1.57-.36l-1.07-.31-.33.1c-1.52.46-3.01.91-4.42 1.3-1.41.4-2.66.73-3.72.98-1.05.25-1.86.4-2.42.45-.18.01-.35-.02-.49-.1-.13-.07-.22-.18-.26-.31-.03-.12.01-.23.01-.23 0 0 .02-.07.12-.06.11.02.42-.05.89-.23.48-.17 1.07-.46 1.76-.84.68-.38 1.41-.85 2.16-1.39.76-.54 1.49-1.15 2.18-1.81.7-.66 1.32-1.34 1.86-2.01.53-.66.93-1.27 1.19-1.81v-.01c-1.44-.52-2.69-.96-3.7-1.31-1-.34-1.73-.58-2.19-.74-.18-.06-.31-.16-.39-.29-.07-.12-.1-.26-.06-.39.04-.13.12-.22.24-.27.11-.04.26-.06.26-.06 0 0 .37-.04.99-.11.6-.07 1.47-.18 2.4-.34.26-.04.53-.09.8-.14-1-.69-1.85-1.52-2.44-2.52-.63-1.06-.97-2.22-.97-3.42 0-1.14.28-2.22.79-3.19.51-.96 1.24-1.79 2.14-2.48C5.2.82 6.35.26 7.6-.15c1.29-.42 2.69-.63 4.16-.63h.35z" />
    </svg>
  );
...
export const CustomerServiceIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12v-1a8 8 0 1 1 16 0v1" />
...
export const LinkedInBrandIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
...
export const TikTokIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.89-.6-4.13-1.46-.35-.24-.68-.52-.98-.81V15c.02 2.76-1.11 5.41-3.13 7.28-2.12 1.95-5.17 2.77-7.97 2.18-3.05-.65-5.64-3.06-6.32-6.12-.87-3.99 1.13-8.28 4.86-9.98 1.15-.54 2.42-.8 3.69-.79v4.04c-1.33-.05-2.7.46-3.59 1.45-.89.99-1.17 2.45-.76 3.72.41 1.27 1.55 2.27 2.87 2.52 1.32.25 2.73-.2 3.62-1.2.9-.99 1.12-2.47 1.12-3.8V.02z"/>
    </svg>
  );
...
export const SpinnerIcon = ({ className }: IconProps) => (
    <svg className={`animate-spin ${className || ""}`} fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const Icons = {
  ...
  MetaBrand: MetaBrandIcon,
  TikTokBrand: TikTokBrandIcon,
  SnapchatBrand: SnapchatBrandIcon,
  Gauge: GaugeIcon,
  Store: StoreIcon,
  Restore: RestoreIcon,
  Command: CommandIcon,
  ...
  Target: TargetIcon,
  LinkedInBrand: LinkedInBrandIcon,
  Youtube: YoutubeIcon,
