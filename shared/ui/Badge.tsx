  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors duration-500  focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-destructive/3 text-destructive/90  hover:bg-destructive/80 hover:text-destructive-foreground",
        danger:
        ...
        info:
          "border-transparent bg-info/10 text-info  hover:bg-info hover:text-info-foreground",
