...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle text-xs font-semibold uppercase tracking-wider text-muted-foreground [&:has([role=checkbox])]:pr-0 [&:not([dir=rtl])]:text-left [dir=rtl]:text-right",
      className
    )}
    {...props}
  />
