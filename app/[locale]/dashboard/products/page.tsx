...
import { useProducts, useDeleteProduct, useRestoreProduct, useHardDeleteProduct } from '@/hooks/api/useProducts';
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={() => { setViewTab('active'); setPage(1); }}
        ...
        <button
          onClick={() => { setViewTab('deleted'); setPage(1); }}
          className={`px-5 py-2 rounded-xl text-sm font-bold transition-all ${
            viewTab === 'deleted'
                ...
                {viewTab === 'active' ? (
                  ...
                  <>
                    <Button
                      size="sm"
                      variant="secondary"
                      className="bg-green-500/10 hover:bg-green-500 hover:text-white border border-green-500/30 rounded-xl px-5 h-9 font-bold shadow-sm transition-all active:scale-95 text-green-700 dark:text-green-400"
