            ...
            <TableBody>
              {isLoading ? (
                ...
                data.data.map((brand: Brand) => (
                  <TableRow key={brand._id} className="group hover:bg-secondary/20 transition-colors">
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="font-bold text-foreground">{getTrans(brand.name)}</div>
                    </TableCell>
        ...
        {data?.metadata && data.metadata.numberOfPages > 1 && (
          <div className="p-4 border-t border-border bg-secondary/10 flex items-center justify-between">
            <p className="text-sm text-muted-foreground font-medium">
               Page {page} of {data.metadata.numberOfPages}
            </p>
            <Pagination
              currentPage={page}
