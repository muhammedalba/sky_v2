...
export default function ProductDetailsClient({ params }: { params: Promise<{ locale: string; slug: string }> }) {
    ...
    const categoryName = typeof product?.category === 'object' && product.category !== null ? getTrans(product.category.name) : 'Uncategorized';
                ...
                <div className="flex flex-col">
                    ...
                    <div className="mt-auto pt-8 border-t border-border/50">
                        <div className="flex flex-col sm:flex-row gap-4 mb-8">
                            ...
                            <Button
                                size="lg"
                                className="flex-1 h-16 rounded-full text-xl font-black shadow-2xl shadow-primary/30 hover:scale-[1.02] active:scale-[1.98] transition-all"
