            ...
            <ScrollReveal animation="slide-right">
              <div className="space-y-6">
                {[
                  ...
                  <Card
                    key={i}
                    className="p-6 border-border/50 shadow-sm hover:shadow-md transition-all group rounded-3xl"
                  >
                    <div className="flex gap-5">
                      <div
                        className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform ${item.color}`}
                      >
              ...
              <Card className="mt-12 p-8 bg-foreground text-background rounded-4xl border-none overflow-hidden relative group">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <p className="text-background/70 font-medium leading-relaxed italic">
                    "نحن نؤمن بأن الجودة ليست مجرد معيار، بل هي التزامنا تجاه كل
                    مشروع نساهم فيه."
                  </p>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                          <label className="text-sm font-black tracking-wide text-foreground/80 uppercase ml-1">
                            {t("form.name")}
                          </label>
                          <Input
                          ...
                          />
                          {errors.name && (
                            <p className="text-xs text-destructive font-black ml-1">
                              {errors.name.message}
                            </p>
                          )}
                        </div>
