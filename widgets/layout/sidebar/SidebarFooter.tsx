    ...
    <div className="p-4 border-t border-border/40 mt-auto bg-accent/5">
      {!isCollapsed ? (
        <div className="flex items-center gap-3 rounded-2xl border border-border/50 bg-background/50 p-3 shadow-sm hover:border-primary/30 transition-colors group">
           <div className="h-10 w-10 shrink-0 rounded-xl bg-linear-to-br from-primary to-info p-[2px] shadow-lg shadow-primary/20">
        ...
        <div className="flex justify-center">
          <div className="h-10 w-10 rounded-xl bg-linear-to-br from-primary to-info flex items-center justify-center text-white text-sm font-black shadow-lg shadow-primary/20 hover:scale-110 transition-transform cursor-pointer">
            {user?.name?.charAt(0) || 'U'}
          </div>
        </div>
      )}
