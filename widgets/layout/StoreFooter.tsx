  ...
  return (
    <footer className="relative border-t border-border/40 bg-linear-to-b from-background to-muted/20 text-foreground pt-16 pb-4 overflow-hidden transition-all duration-300">
      ...
      >
        ...
        <ScrollReveal
          animation="slide-up"
          className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 mb-12"
        >
            ...
            <div className="flex flex-wrap items-center gap-2.5 mt-2">
              {socialLinks.facebook && (
                <a
                  ...
                  title="Facebook"
                  className="p-2 rounded-xl bg-card border border-border hover:border-primary/30 hover:bg-primary/10 hover:text-primary transition-all duration-300"
                >
          ...
          >
            ...
            <ul className="space-y-3 font-medium">
              <li>
                <Link
                  href="/home"
                  className="text-xs sm:text-sm text-muted-foreground hover:text-primary hover:translate-x-1 inline-block transition-all duration-300"
                >
                  &middot; {navT("home")}
                </Link>
              </li>
